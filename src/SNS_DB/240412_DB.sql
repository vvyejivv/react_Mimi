...
INSERT INTO `user` (`USERID`, `PWD`, `NAME`, `BIRTH`, `PHONE`, `EMAIL`, `CDATE`, `GRADE`, `INTRO`) VALUES
	('noah', '1234', '한노아', '20010210', '010-8756-1234', 'noah@plave.com', '2024-04-11 18:04:29', '1', '플레이브 노아입니다.'),
	...
	('yejun', '1234', '남예준', '20010912', '010-9999-8888', 'yejun@plave.com', '2024-04-09 18:10:21', '1', '플레이브 예준입니다.');
...
INSERT INTO `user_post` (`POSTNO`, `USERID`, `TITLE`, `CONTENTS`, `LIKES`, `HIT`, `CDATE`, `UDATE`) VALUES
	...
	(25, 'yeji', '해바라기 필드 속에서 행복한 하루', '나른한 오후, 해바라기 필드에 누워 있는 것만으로도 마음이 편안해져요. \n바람에 흔들리는 해바라기들이 나를 반기며 웃는 듯한 기분! 노란색 하늘 아래에 누워 하나하나의 꽃들을 살펴보니 각기 다른 모습들이 너무 아름다워요. 오늘도 해바라기 필드에서 평온함을 느끼고 있어요.', 0, 0, '2024-04-11 17:56:41', NULL),
	(26, 'yeji', '카페에서 마시는 커피 한 잔', '소리 없는 카페에서 나만의 시간을 갖고 있어요. 커피향이 가득한 곳에서 차분한 음악 소리를 들으며 창밖으로 보이는 풍경을 즐기고 있어요. 이런 시간이 너무 소중하죠', 0, 0, '2024-04-11 17:58:16', NULL),
	(27, 'yejun', '안녕하세요. 플레이브 리더 예준입니다.', '저번 여름에 발표한 [여섯 번째 여름] 보내주신 많은 응원 감사드립니다.', 0, 0, '2024-04-11 18:02:06', NULL),
	(28, 'noah', '플레이브 이번 주 주말 콘서트 합니다~', '안녕하세요. 플레이브의 노아입니다. \n저희 이번주에 콘서트 하는데 많은 관심 부탁드립니다.', 0, 0, '2024-04-11 18:05:12', NULL);
...
-- 테이블 데이터 sns_kimyeji.user_post_comment:~0 rows (대략적) 내보내기
INSERT INTO `user_post_comment` (`COMMENTNO`, `POSTNO`, `COMMENT`, `USERID`, `CDATE`) VALUES
	...
	(11, 27, '노래 너무 좋아요~~', 'yeji', '2024-04-11 18:05:43'),
	(12, 28, '저도 가고 싶어요 ㅠㅠ', 'test', '2024-04-11 18:06:11');
...
-- 테이블 데이터 sns_kimyeji.user_post_photo:~7 rows (대략적) 내보내기
INSERT INTO `user_post_photo` (`POSTFILENO`, `POSTNO`, `FILEPATH`, `FILENAME`, `FILEORGNAME`, `FILESIZE`, `FILEETC`) VALUES
	(10, 23, './img/', '240411172946_asdsada.png', 'asdsada.png', NULL, NULL),
	(11, 24, '/img/', '240411174636_tkscor.jpg', 'tkscor.jpg', NULL, NULL),
	(12, 25, '/img/', '240411175641_goqkfkrl.jpg', 'goqkfkrl.jpg', NULL, NULL),
	(13, 26, '/img/', '240411175816_cafe.jpg', 'cafe.jpg', NULL, NULL),
	(14, 27, '/img/', '240411180206_yejun.gif', 'yejun.gif', NULL, NULL),
	(15, 28, '/img/', '240411180512_noah.gif', 'noah.gif', NULL, NULL),
	(16, 0, '/img/', '240412100046_asdsada.png', 'asdsada.png', NULL, NULL);
...
-- 테이블 데이터 sns_kimyeji.user_profile_photo:~1 rows (대략적) 내보내기
INSERT INTO `user_profile_photo` (`USERPROFILENO`, `USERID`, `FILEPATH`, `FILENAME`, `FILEORGNAME`, `FILESIZE`, `FILEETC`) VALUES
	(2, 'yeji', NULL, '240412100609_yeji.jpg', 'yeji.jpg', NULL, NULL),
	(3, 'yejun', NULL, '240412110001_yejun.jpg', 'yejun.jpg', NULL, NULL),
	(4, 'noah', NULL, '240412110056_noah.jpg', 'noah.jpg', NULL, NULL);
